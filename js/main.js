$(document).ready(function() {
  ...
  $('.todo-form .new-btn').click(function() {
    ...
    if(text.length > 0) {
      $('.todo-content .todo-all').append('<li class=id_'+ counter +'><p>'+ text +'</p><div class="icon"><i class="fa fa-trash" aria-hidden="true"></i><i class="fa fa-pencil" aria-hidden="true"></i></div></li>');
